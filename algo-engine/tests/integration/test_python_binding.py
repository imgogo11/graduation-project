...
def load_algo_engine_module() -> AlgoEngineModuleProtocol:
    return cast(AlgoEngineModuleProtocol, import_module("algo_engine_py"))
...
def main() -> int:
    ...
    algo_engine_py = load_algo_engine_module()

    tree = algo_engine_py.RangeMaxSegmentTree([100, 250, 250, 80])
