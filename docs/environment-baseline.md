...
The web dev server defaults to `4173` instead of `5173`, because some Windows environments reserve the `5173` port range and reject local binds.
...
After startup, the web app is expected at `http://127.0.0.1:4173`.
