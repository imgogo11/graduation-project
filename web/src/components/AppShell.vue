  ...
  <div class="shell">
    <header class="shell__header">
      <div class="shell__hero">
        <div class="shell__eyebrow">Design and Implementation of Stock Trading Data Management and Analysis System</div>
        <h1 class="shell__title">股票交易数据管理与分析系统的设计与实现</h1>
        <p class="shell__subtitle">
          统一承接用户注册登录、CSV/XLSX 历史交易数据上传、按用户隔离的数据管理，以及由
          C++ 算法模块和 Python 分析层共同支撑的多维度交易分析能力。
        </p>
      </div>
